...
# when we give input (json format), capatured into data key. When hit predict_api
## as a post request, standard scarlar and linear reg kicks in to predict the o/p
def predict_api():
